...
class TimerManager {
    ...
    /**加入到排序队列 */
    private addObject(target:any):void {
    ...
    private objectSort():void {
        ...
        this.addObject(GameData.heros);
        this.addObject(GameData.monsters);
        this.addObject(GameData.boss);
        this.addObject(GameData.stakes);
